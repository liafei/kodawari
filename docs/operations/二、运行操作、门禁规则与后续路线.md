...
- `GITHUB_STEP_SUMMARY`
- always-on / integration workflows keep a non-blocking advisory gate snapshot
  under `planning/ci_repo_health_src`; integration still fails closed when
  required reviewer environment variables are missing.
